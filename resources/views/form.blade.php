      ...
      <div class="p-4 sm:ml-64">
         <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg mt-14">
            ...
            <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                <h2 class="text-2xl font-semibold mb-4">Doctor Information</h2>
                
                <div class="grid grid-cols-2 gap-4">
                    <div class="mb-4">
                        <label class="block text-gray-700 text-sm font-bold mb-2" for="name">Name</label>
                        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="name" type="text" placeholder="Doctor's Name">
                    </div>
                    <!-- Add other Doctor fields here (department_id, qualification, designation, etc.) -->
                </div>
        
                <!-- Section 2: Department Column -->
                <h2 class="text-2xl font-semibold mb-4 mt-8">Department Information</h2>
                
                <div class="grid grid-cols-2 gap-4">
                    <div class="mb-4">
                        <label class="block text-gray-700 text-sm font-bold mb-2" for="department_name">Department Name</label>
                        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="department_name" type="text" placeholder="Department Name">
                    </div>
                    <!-- Add other Department fields here (description, image, icon, etc.) -->
                </div>
        
                <!-- Section 3: Timetable Column -->
                <h2 class="text-2xl font-semibold mb-4 mt-8">Timetable Information</h2>
                
                <div class="grid grid-cols-2 gap-4">
                    <div class="mb-4">
                        <label class="block text-gray-700 text-sm font-bold mb-2" for="timetable_doctor_id">Doctor ID</label>
                        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="timetable_doctor_id" type="text" placeholder="Doctor ID">
                    </div>
                    <!-- Add other Timetable fields here (day, start_time, end_time, etc.) -->
                </div>
