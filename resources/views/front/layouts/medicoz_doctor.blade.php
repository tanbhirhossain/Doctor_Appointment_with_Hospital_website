...
<html lang="en">
   <head>
      ...
      <title>Medizco Medical Center - HTML Template | Doctors</title>
      ...
      <link rel="stylesheet" href="{{ asset('front/asset/css/magnific-popup.css')}}">
   ...
   <body>
      <div class="page-wrapper">
            ...
            <div class="header-top">
               <div class="container ">
                  <div class="top-outer clearfix">
                     <ul class="top-left">
                        <li><span class="icon flaticon-phone-receiver"></span>Phone: +1 (212) 305-2500</li>
                        <li><span class="icon flaticon-clock-1"></span>Mon-Fri (8am - 6pm)</li>
                        <li><span class="icon flaticon-letter"></span><a href="https://html.xpeedstudio.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="452c2b232a05203d24283529206b262a28">[email&#160;protected]</a></li>
                     </ul>
                              ...
                              <li class="elementskit-dropdown-has">
                                 ...
                                 <ul class="elementskit-dropdown elementskit-submenu-panel">
                                    ...
                                    <li class="elementskit-dropdown-has">
                                       ...
                                       <ul class="elementskit-dropdown elementskit-submenu-panel">
                                          <li class="active"><a href="index-2.html">Header Style 01</a></li>
               ...
               <div class="mixitup-gallery">
                  ...
                  <div class="filter-list row">
                     ...
                     <div class="team-block all mix xray polmonary col-lg-3 col-md-6 col-sm-12">
                        <div class="inner-box">
                           <div class="image">
                              <img src="{{ asset('front/asset/images/resource/team-2.jpg') }}" alt />
                              <div class="overlay-box">
                                 <div class="overlay-inner">
                                    <ul class="team-social-box">
                                       <li class="youtube"><a href="#" class="icon icon-youtube"></a><span class="social-name">youtube</span></li>
                     ...
                     <div class="team-block all mix xray cardiology col-lg-3 col-md-6 col-sm-12">
                        <div class="inner-box">
                           <div class="image">
                              <img src="{{ asset('front/asset/images/resource/team-3.jpg') }}" alt />
                              <div class="overlay-box">
                                 <div class="overlay-inner">
                                    <ul class="team-social-box">
                                       <li class="youtube"><a href="#" class="icon icon-youtube"></a><span class="social-name">youtube</span></li>
                     ...
                     <div class="team-block all mix deurology cardiology col-lg-3 col-md-6 col-sm-12">
                        <div class="inner-box">
                           <div class="image">
                              <img src="{{ asset('front/asset/images/resource/team-4.jpg') }}" alt />
                              <div class="overlay-box">
                                 <div class="overlay-inner">
                                    <ul class="team-social-box">
                                       <li class="youtube"><a href="#" class="icon icon-youtube"></a><span class="social-name">youtube</span></li>
         ...
         <section class="price-section">
            <div class="pattern-layer-one" style="background-image:url(images/background/pattern-21.png') }})"></div>
                     ...
                     <div class="footer-column col-lg-6 col-md-6">
                        <div class="footer-widget logo-widget">
                           ...
                           <ul class="list-style-two">
                              ...
                              <li><a href="https://html.xpeedstudio.com/cdn-cgi/l/email-protection#fc95929a93bc99849d918c9099d29f9391"><span class="icon flaticon-mail"></span><span class="__cf_email__" data-cfemail="0861666e67486d70696578646d266b6765">[email&#160;protected]</span></a></li>
                           </ul>
                        </div>
                     </div>
                     ...
                     <div class="content-inner">
                        ...
                        <div class="contact-info">
                           ...
                           <ul class="list-style-one">
                              ...
                              <li><span class="icon flaticon-letter"></span><a href="https://html.xpeedstudio.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="bcf1d9d8d5c6dfd3fcdbd1ddd5d092dfd3d1">[email&#160;protected]</a></li>
      ...
      <script src="j{{ asset('front/assets/bootstrap.min.js')}}"></script>
      <script src="{{ asset('front/assetjs/jquery.fancybox.js')}}"></script>
      <script src="{{ asset('front/assetjs/jquery.magnific-popup.min.js')}}"></script>
      <script src="{{ asset('front/assetjs/jquery.mCustomScrollbar.concat.min.js')}}"></script>
      <script src="{{ asset('front/assetjs/owl.js')}}"></script>
      <script src="{{ asset('front/assetjs/mixitup.js')}}"></script>
      <script src="{{ asset('front/assetjs/paroller.js')}}"></script>
      <script src="{{ asset('front/assetjs/wow.js')}}"></script>
      <script src="{{ asset('front/assetjs/main.js')}}"></script>
      <script src="{{ asset('front/assetjs/nav-tool.js')}}"></script>
      <script src="{{ asset('front/assetjs/jquery-ui.js')}}"></script>
      <script src="{{ asset('front/assetjs/appear.js')}}"></script>
      <script src="{{ asset('front/assetjs/script.js')}}"></script>
   </body>
   <!-- Mirrored from html.xpeedstudio.com/medizco/doctor.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 11 Feb 2024 05:41:14 GMT -->
</html>